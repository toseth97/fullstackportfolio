...
const Footer = () => {
  return (
    <footer className="w-full flex flex-col items-center justify-center bg-black border-t border-green-400">
      <div className="lg:w-9/12 w-10/12 flex lg:flex-row flex-col lg:justify-between justify-center items-center lg:my-16 py-2 gap-8">
        <h1 className="w-11/12 lg:w-4/12 lg:text-4xl text-3xl lg:text-left text-center title_text font-bold text-green-400">
          Security-driven engineering & web testing
        </h1>
        <div className="hLine w-4/12 hidden lg:flex" />
        <div className="flex flex-col sm:flex-row items-center gap-4">
          <Link
            href="/contact"
            className="portfolioBtn inline-block my-2 mb-2 py-3 px-16 text-sm shadow-green-500/50"
          >
            CONTACT
          </Link>
          <CvDownloadMenu />
      ...
      <div className="w-full bg-black/50 backdrop-blur-md flex items-center justify-center border-t border-green-400">
        <div className="w-10/12 flex lg:flex-row flex-col items-center lg:justify-between justify-center py-2">
          ...
          <ul className="flex lg:flex-row flex-col items-center lg:justify-between justify-center gap-5 text-white text-xs lg:pb-0 pb-8">
            <li className="list-item text-sm">
              <Link
                className="mx-4 px-2 inline-block hover:text-green-400 transition-colors"
                href="/"
              >
                HOME
              </Link>
