        ...
        <header className='w-full flex flex-col items-center justify-center shadow-lg sticky top-0'>
            <nav className='lg:w-9/12 w-11/12 flex items-center justify-between py-2 '>
                ...
                <ul className='lg:flex hidden items-center justify-between gap-5 '>
                    <li className='listItem text-sm' id='home' ><Link className='mx-4 px-2' to='/'>HOME</Link></li>
                    <li className='listItem text-sm' id='portfolio' ><Link className=' mx-4 px-2' to='/portfolio'>PORTFOLIO</Link></li>
                    <li className='listItem text-sm' id='contact' ><Link className=' mx-4 px-2' to='/contact'>CONTACT</Link></li>
                    <li className='listItem text-sm' id='blog' ><Link className='blogBtn text-white mx-4 px-8 py-2' to='/blog'>BLOG</Link></li>
