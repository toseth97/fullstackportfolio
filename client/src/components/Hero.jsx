    ...
    <section className='w-full flex flex-col justify-center items-center mt-4 lg:mt-8  '>
        <div className='lg:w-9/12 w-11/12 flex flex-col justify-center items-center relative'>
            ...
            <div className='heroIntro lg:w-7/12 w-11/12 lg:absolute relative bottom-8  lg:left-0 left:0 mt-8 lg:p-8 p-0 lg:mt-0'>
                ...
                <Link to="/#about" onClick={handleClick} className='aboutBtn inline-block py-4 px-16 mb-8 text-white text-sm'>About Me</Link>
            </div>
        </div>
        ...
        <div ref={mySectionRef} id='about' className=' lg:w-8/12 w-10/12 flex lg:flex-row flex-col lg:justify-between justify-center my-4 pb-8 pt-16 gap-16'>
          <img src={AboutImg} alt='portrait' className='lg:w-5/12 w-full rounded'  />
          <div className='lg:w-5/12 w-full border-t border-b lg:py-8 py-1 text-justify lg:text-left'>
            ...
            <p>
            <Link to="/portfolio"  className='portfolioBtn lg:inline-block block my-16 mb-2 py-3 px-16 text-sm text-center' >CHECK MY PORTFOLIO</Link>
            </p>
          </div>
